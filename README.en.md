...
中文说明（以及这个工具的来历和截图）：[README.md](README.md)
...
Built for using a GoPro as a dashcam, entirely by chatting with Claude — the story, with
screenshots, is in the Chinese README. Spec and design decisions: [`docs/SPEC.md`](docs/SPEC.md).
